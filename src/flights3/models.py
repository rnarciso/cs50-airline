...
class Airport(models.Model):
    ...
    def get_absolute_url(self):
        return reverse("flights3:airport_detail", kwargs={"pk": self.pk})
...
class Flight(models.Model):
    ...
    def get_absolute_url(self):
        return reverse("flights3:flight_detail", kwargs={"pk": self.pk})
...
class Passenger(models.Model):
    ...
    def get_absolute_url(self):
        return reverse("flights3:passenger_detail", kwargs={"pk": self.pk})
